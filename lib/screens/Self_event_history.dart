...
class EventSelfHistory extends StatefulWidget {
  const EventSelfHistory({super.key});

  @override
  State<EventSelfHistory> createState() => _EventSelfHistoryState();
}

class _EventSelfHistoryState extends State<EventSelfHistory> {
                    ...
                    child: Column(
                      children: <Widget>[
                        StreamBuilder<QuerySnapshot>(
                          stream: searching == ""? _firestore.collection('event_attendance').where('Faculty', isEqualTo: curr).orderBy('Submission', descending: true).snapshots():_firestore.collection('event_attendance').where('Faculty', isEqualTo: curr).where('Date', isEqualTo: searching).orderBy('Submission', descending: true).snapshots(),
