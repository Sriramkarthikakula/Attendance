...
class _AttendanceCalState extends State<AttendanceCal> {
  ...
  void func1(String deptvalue, String yearvalue) async {
    ...
    for (var message in messages.docs) {
      ...
      if (data.containsKey(deptvalue) &&
          data[deptvalue].containsKey(yearvalue)) {
        setState(() {
          Sections = ["Select"];
          Sections = Sections + data[deptvalue][yearvalue]['section'];
          fetched_Academic_year =
              data[deptvalue][yearvalue]['Academic_year_begins'];
        });
        break;
      } else {
        continue;
  ...
  Future<List<Datawidget>> gettingClassList(
      String deptValue, String YearValue, String sectionvalue) async {
    ...
    for (var items in class_list) {
      ...
      QuerySnapshot querySnapshot = await _firestore
          ...
          .where('Course_name', isEqualTo: items)
          ...
          child: Row(
            ...
            children: [
              DropdownMenu<dynamic>(
                ...
                dropdownMenuEntries:
                    branches.map<DropdownMenuEntry<String>>((dynamic value) {
          ...
          child: Row(
            ...
            children: [
              DropdownMenu<dynamic>(
                ...
                dropdownMenuEntries:
                    Sections.map<DropdownMenuEntry<String>>((dynamic value) {
                  return DropdownMenuEntry<String>(value: value, label: value);
                }).toList(),
              ),
              Padding(
                ...
                child: TextButton(
                  onPressed: () {
                    setState(() {
                      ...
                      lis =
                          gettingClassList(deptvalue, yearvalue, sectionvalue);
                    });
                  },
                  child: Row(
                  ...
                  style: ButtonStyle(
                    backgroundColor:
                        MaterialStateProperty.all(Color(0xff2D3250)),
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Column(
                children: AbyClist1.map((classes) => Text(
                      classes,
                      style: TextStyle(
                        fontSize: 16.0,
                      ),
              ...
              Column(
                children: Percentage1.map((classes) => Text(
                      classes.toString(),
                      style: TextStyle(
                        fontSize: 16.0,
                      ),
          ...
          Row(
            ...
            children: [
              ...
              Container(
                padding: EdgeInsets.symmetric(vertical: 5.0, horizontal: 5.0),
                child: Text(
                  total_classes_completed.toString(),
                  style: TextStyle(fontWeight: FontWeight.bold),
                ),
                decoration: BoxDecoration(
                  color: Colors.white,
